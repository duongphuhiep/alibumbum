	...
	<body>
		<table class="body" width="80%" align="center" cellspacing="15">
			...
			<tr><td align="center">
				...
				<div class="gr">(views:{vt} comments:{cm})</div>
			</td></tr>
			...
			<tr><td>
					...
					<table width="100%" class="box1" cellpadding="5" cellspacing="0">
						<tr class="smallboxtitle">
							<td>
								<a class="me" href="mailto:{email}">{name}</a> 
								<span class="gr">({comment_ip})</span>
							</td>
							<td align="right">
								{time} &nbsp; 
								<a class="admin" href="delcomment.php?id={comment_id}">delete</a>
							</td>
						</tr>
